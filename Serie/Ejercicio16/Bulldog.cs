...
{
    //Clase Bulldog que hereda de la clase Perro
    class Bulldog : Perro
    {
        //Método Ladra que sobrescribe el método Lladra de la clase Perro
        ...
        //Método constructor
        public Bulldog() { raza = "Bulldog"; }
        //Método Constructor con sobrecargo.
        public Bulldog(string nombre, double peso, double altura, string color)
        {
            Nombre = nombre;
            Peso = peso;
            Altura = altura;
