...
namespace Menu2
{
    public partial class Form1 : Form
    {
        ...
        public void clearType()
        {
            ...
            cursivasToolStripMenuItem.Checked = false;
        }
        ...
        {
            MessageBox.Show("Fue hecho por Alberto Colula");
        ...
        private void cursivasToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            clearType();
            label1.Font = new Font(label1.Font, FontStyle.Italic);
            cursivasToolStripMenuItem.Checked = true;
        }

        private void negritasToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
